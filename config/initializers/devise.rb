...
Devise.setup do |config|
  ...
  config.secret_key = ENV['DEVISE_SECRET_KEY'] if Rails.env == 'production' or Rails.env == 'test'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class
  # with default "from" parameter.
  config.mailer_sender = 'plus.nctu.edu.tw'
  ...
  # config.authentication_keys = [ :email ] # WE DEFINE IN USER MODEL
  ...
  # config.pepper = 'a01fb5d8c1e3a701e6eb7953444615ebede4d13cbceb04b282ab6d0d809a30fdcbd5235ed2dda3871ca815b129341c738d01e8bb7a2c0bbe31f9728cab70abdf'
